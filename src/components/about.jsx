    ...
    return (
      <Flex as={"section"} id="about" px={4} py={8} background={"blackAlpha.800"} display={"flex"} flexDir={"column"} alignItems={{sm:"left", md:"center"}}>
        <Flex alignItems={"center"} flexDirection={"column"} w={{sm:"full", md:"75%"}}>
          <Heading pb={2} w={"100%"} textAlign={"left"} color="font.lightViolet" fontSize={{sm:"xl", md:"3xl"}}>About me</Heading>
          <Text lineHeight={1.9} fontSize={{sm:"md", md:"xl"}} color={"whiteAlpha.900"}>
            Hi! My name is Sergio (AKA Ian Rue). My passion is to create high quality sounds and music for video games and films. I also implement them using Wwise, Unreal 5, Unity and C#. 
          <Text lineHeight={1.9}>
